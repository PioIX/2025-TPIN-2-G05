...
export default function Home(){
    ...
    return(
        <div>
            ...
            <ImagenClick onClick={jugar} src={"../../../keykeys/public/jugar.png"}/>
            <ImagenClick onClick={creditos} src={"../../../keykeys/public/creditos.png"}/>
            <ImagenClick onClick={iniciarSesion} src={"../../../keykeys/public/iniciarSesion.png"}/>
        </div>
